...
export interface ISessionServiceClient {
    ...
    /**
     * @generated from protobuf rpc: SaveRuntimeSnapshot(butler.SaveSessionRequest) returns (butler.SaveSessionResponse);
     */
    saveRuntimeSnapshot(input: SaveSessionRequest, options?: RpcOptions): UnaryCall<SaveSessionRequest, SaveSessionResponse>;
    /**
     * @generated from protobuf rpc: LoadRuntimeSnapshot(butler.LoadSessionRequest) returns (butler.LoadSessionResponse);
     */
    loadRuntimeSnapshot(input: LoadSessionRequest, options?: RpcOptions): UnaryCall<LoadSessionRequest, LoadSessionResponse>;
}
/**
 * @generated from protobuf service butler.SessionService
 */
